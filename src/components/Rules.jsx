        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              >
                <i className={`${platform.icon} text-2xl ${platform.name === '开源中国' ? 'text-green-600' : 'text-blue-600'} mb-2 group-hover:${platform.name === '开源中国' ? 'text-green-700' : 'text-blue-700'} transition-colors`}></i>
