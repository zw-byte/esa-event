          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-blue-800 leading-relaxed">
                投稿作品的著作权归属于作者所有，阿里云 ESA 享有作品的使用权，有权将优秀作品收录至官网文档实践案例库或发布于官方技术自媒体账号、活动页、官方博客站点等渠道进行宣传推广。投稿即视为同意主办⽅在合规范围内使⽤内容，不作商业转售。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              { name: '开源中国', icon: 'fas fa-code', url: 'https://www.oschina.net' }
            ].map((platform, index) => (
              <a 
                key={index} 
                href={platform.url}
